...
function updateImages() {
  ...
  if (window.innerWidth < 767) {
    lendingSection.style.backgroundImage = "url('/wheel-of-fortune/images/phonebg.jpg')";
    document.querySelector(".svg-img-stone").src = "/wheel-of-fortune/images/stonephone.svg";
  } else if (window.innerWidth < 968) {
    lendingSection.style.backgroundImage = "url('/wheel-of-fortune/images/ipad.jpg')";
    document.querySelector(".svg-img-stone").src = "/wheel-of-fortune/images/stoneipad2.svg";
  } else {
    lendingSection.style.backgroundImage = "url('/wheel-of-fortune/images/PCbg.jpg')";
    document.querySelector(".svg-img-stone").src = "/wheel-of-fortune/images/stonepc.svg";
  }

  if (window.innerWidth < 767 || window.innerWidth < 968) {
    document.querySelector(".png-img-wheel").src = "/wheel-of-fortune/images/wheel2.png";
  } else {
    document.querySelector(".png-img-wheel").src = "/wheel-of-fortune/images/wheelpc.png";
  }
